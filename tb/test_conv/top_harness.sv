// top_harness.sv
// Phase 13: identical to tb/test_top/top_harness.sv. Wraps tinyNPU_top with
// four sram_wrapper instances (IFM/W/BIAS/OFM) and exposes backdoor write
// ports for IFM/W/BIAS plus a backdoor read port for OFM. The cocotb
// Conv2D testbench performs im2col in software, loads the resulting GEMM
// matrices through the backdoors, kicks via APB, then reads OFM back.
